...
description: Study a research paper - parse PDF, generate materials, code demos, and interactive explorer
---

## Your task

Study a research paper using the full paper study workflow.
